...
public class ActivityListAdapter extends RecyclerView.Adapter<ActivityListAdapter.MyViewHolder> {
    ...
    public ActivityListAdapter(Activity context, ArrayList<ElectionProject> projectList) {
    ...
    public ActivityListAdapter.MyViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        ActivityListAdapterBinding activityListAdapterBinding =
                DataBindingUtil.inflate(layoutInflater, R.layout.activity_list_adapter, viewGroup, false);
        return new ActivityListAdapter.MyViewHolder(activityListAdapterBinding);

    }


    public class MyViewHolder extends RecyclerView.ViewHolder {
        private ActivityListAdapterBinding activityListAdapterBinding;

        public MyViewHolder(ActivityListAdapterBinding Binding) {
      ...
      holder.activityListAdapterBinding.activityName.setText(projectList.get(position).getActivity_description());
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ((Dashboard)context).showPollingActivityScreen();
            }
        });
